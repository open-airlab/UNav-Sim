...
namespace airlib
{
    ...
    private: //methods
        static void setOutput(Output& output, const RotorParams& params, const FirstOrderFilter<real_T>& control_signal_filter, RotorTurningDirection turning_direction)
        {
            ...
            output.speed = output.control_signal_filtered * params.max_speed_square;
            ...
            output.torque_scaler = output.control_signal_filtered * 0.0 * static_cast<int>(turning_direction);
