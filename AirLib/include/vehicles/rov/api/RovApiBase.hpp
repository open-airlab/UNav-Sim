...
#ifndef msr_airlib_DroneVTOLControlServer_hpp
#define msr_airlib_DroneVTOLControlServer_hpp

#include "common/Common.hpp"
#include "RovCommon.hpp"
...
namespace airlib
{
    ...
    class RovApiBase : public VehicleApiBase
    {
    ...
    protected: //must be implemented
        ...
        virtual const RovApiParams& getRovApiParams() const = 0;
    ...
    protected: //types
        ...
        struct StatusLock
        {
            ...
            StatusLock(const RovApiBase* api)
                : lock_(
